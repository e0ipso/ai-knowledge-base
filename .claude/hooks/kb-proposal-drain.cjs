...
function packageRoot() {
  return (0, import_node_path2.resolve)((0, import_node_path2.dirname)((0, import_node_url.fileURLToPath)(importMetaUrl)), "..");
}
...
function findRepoRoot(from = process.cwd()) {
  ...
  while (true) {
    if ((0, import_node_fs2.existsSync)((0, import_node_path2.join)(cur, ".git")) || (0, import_node_fs2.existsSync)((0, import_node_path2.join)(cur, ".ai/knowledge-base/.state/installed-version"))) {
      return cur;
    }
...
function repoPaths(root) {
  ...
  const kbDir = (0, import_node_path2.join)(aiDir, "knowledge-base");
  const stateDir = (0, import_node_path2.join)(kbDir, ".state");
  const configDir = (0, import_node_path2.join)(kbDir, ".config");
  ...
  return {
    ...
    projectConfigFile: (0, import_node_path2.join)(kbDir, "config.yaml"),
    sessionsDir: (0, import_node_path2.join)(kbDir, "_sessions"),
    logsDir: (0, import_node_path2.join)(kbDir, "_logs"),
    nodesDir: (0, import_node_path2.join)(kbDir, "nodes"),
    conflictsDir: (0, import_node_path2.join)(kbDir, "conflicts"),
    gitignoreFile: (0, import_node_path2.join)(root, ".gitignore"),
...
// src/harnesses/claude/headless.ts
init_cjs_shims();
...
var getTargetFd = ({ value, optionName, fdNumber, direction }) => {
  ...
  return { type: "uint8Array", value: bufferToUint8Array((0, import_node_fs7.readFileSync)(targetFdNumber)), optionName };
};
...
var addPropertiesSync = {
  input: {
    ...addProperties,
    fileUrl: ({ value }) => ({ contents: [bufferToUint8Array((0, import_node_fs8.readFileSync)(value))] }),
    filePath: ({ value: { file } }) => ({ contents: [bufferToUint8Array((0, import_node_fs8.readFileSync)(file))] }),
...
var handleDummyPromise = async (error, verboseInfo, options2) => handleResult2(error, verboseInfo, options2);
...
var addPropertiesAsync = {
  ...
  output: {
    ...
    filePath: ({ value: { file, append } }) => ({ stream: (0, import_node_fs10.createWriteStream)(file, append ? { flags: "a" } : {}) }),
...
function buildClaudeHarnessOpts(settings, role) {
  const out = { allowedTools: ROLE_ALLOWED_TOOLS[role] };
...
async function runHeadlessClaudeRaw(promptBody, stdin, opts = {}) {
...
async function runHeadlessClaude(promptBody, stdin, schema2, opts = {}) {
...
async function main() {
  ...
  if (raw.trim().length > 0) {
    try {
      ...
      appendHookDiagnostic("claude:kb-proposal-drain", "parse", err, paths2.logsDir);
      input = {};
    }
  }
...
`);
  ...
  const runner = async (prompt, stdin, schema2, opts) => runHeadlessClaude(prompt, stdin, schema2, opts);
  try {
...
function loadProposalPrompt(promptsDir) {
  const override = (0, import_node_path12.join)(promptsDir, "proposal-extract.md");
  if ((0, import_node_fs12.existsSync)(override)) return (0, import_node_fs12.readFileSync)(override, "utf8");
  const bundled = (0, import_node_path12.join)(packageTemplatesDir(), "prompts/proposal-extract.md");
  if ((0, import_node_fs12.existsSync)(bundled)) return (0, import_node_fs12.readFileSync)(bundled, "utf8");
  return null;
}
function readStdin() {
