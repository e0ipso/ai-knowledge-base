...
function findRepoRoot(from = process.cwd()) {
  ...
  while (true) {
    if ((0, import_node_fs5.existsSync)((0, import_node_path4.join)(cur, ".git")) || (0, import_node_fs5.existsSync)((0, import_node_path4.join)(cur, ".ai/knowledge-base/.state/installed-version"))) {
      return cur;
    }
...
async function main() {
  ...
  if (!(0, import_node_fs6.existsSync)(paths.kbDir)) return;
  try {
    ...
    process.stderr.write("\u{1F4F8} KB Capture: Saving session transcript\u2026\n");
    await captureSession(input, {
      sessionsDir: paths.sessionsDir,
      parseTranscript: parseCursorTranscript
    });
    process.stderr.write("\u{1F4BE} KB Capture: Session transcript saved.\n");
  } catch (err) {
