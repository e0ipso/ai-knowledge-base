...
depends_on: []
confidence: high
summary: "Claude and Cursor export in-session env markers; Codex and OpenCode do not. From those sessions or a plain shell, pass --harness explicitly or set cliDefaultHarness."
---
