...
depends_on: []
confidence: high
summary: "/kk-bootstrap samples, follows cross-references, and stops to ask when scope is unclear. Don't read every doc end-to-end."
---

# Bootstrap is supervised and judgmental, not exhaustive

The `/kk-bootstrap` skill is a supervised, judgmental, one-pass operation against the project's existing markdown docs. The user is in the loop and can correct it in flight via the normal session interface.
