---
schema_version: 2
nodes_hash: 'sha256:da9000e11de538d79fc6c68009ca095eb0667d7d6fffc1b3d4a772fb142a492d'
node_count: 4
---
# kenkeep Index: cli
...
- **init and upgrade inject a static kk index pointer into AGENTS.md** [`cli/practice-init-and-upgrade-inject-a-static-kk-index-pointer-into-agents-md.md`] During init and upgrade, a static one-line pointer to INDEX.md is appended to AGENTS.md, guarded by sentinel markers for idempotency. #init #upgrade #agents-md #index #markers
...
- **updateAgentsMd - kk index pointer injection into AGENTS.md** [`cli/map-update-agents-md-kk-index-pointer-injection-into-agents-md.md`] Function in src/commands/init.ts that injects or replaces a sentinel-guarded static pointer to INDEX.md in AGENTS.md. #init #upgrade #agents-md #markers #index
