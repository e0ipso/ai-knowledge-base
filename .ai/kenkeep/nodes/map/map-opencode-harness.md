...
depends_on: []
confidence: high
summary: "OpenCode adapter; single TS plugin shim subscribes to event bus and dispatches session.idle/session.created to per-event Node scripts under .opencode/kk-hooks/."
---
