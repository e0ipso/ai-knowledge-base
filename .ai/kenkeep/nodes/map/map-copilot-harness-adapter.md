...
depends_on: []
confidence: high
summary: "GitHub Copilot CLI adapter; per-event JSON hook config at ~/.copilot/hooks/kk.json; captures on sessionEnd/agentStop from events.jsonl; skills in .github/skills/; no detectFromEnv; session-start INDEX via a sentinel block in .github/copilot-instructions.md."
---
