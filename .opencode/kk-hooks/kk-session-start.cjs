...
runHookEntry({
  ...
  main: async payload => {
    ...
    try {
      ...
      const target = (0, import_node_path11.join)(root, '.opencode', 'AGENTS.md');
      (0, import_node_fs11.mkdirSync)((0, import_node_path11.dirname)(target), { recursive: true });
      (0, import_node_fs11.writeFileSync)(target, `${AGENTS_HEADER}${content}`);
