...
// src/harnesses/opencode/hooks/kk-session-start.ts
init_cjs_shims();
...
function findRepoRoot(from = process.cwd()) {
  ...
  while (true) {
    if ((0, import_node_fs4.existsSync)((0, import_node_path4.join)(cur, ".git")) || (0, import_node_fs4.existsSync)((0, import_node_path4.join)(cur, ".ai/kenkeep/.state/installed-version"))) {
      return cur;
    }
...
function buildSessionStartContext(ctx) {
  ...
  if (shouldNudge) {
    ...
    const copyPaste = "Run `/kk-curate` (or `npx kenkeep curate`). Curation is simple; a mid-tier model at moderate effort is sufficient and cheaper.";
    lines.push("");
    if (loud) {
      lines.push("> \u{1F6A8} kk curation queue is overdue");
      lines.push(
...
function buildNudgeContent(result) {
  const statusLine = result.nudged ? `\u{1F6A8} kk curation overdue: ${result.pendingSessions} pending, ${result.candidateCount} candidates \u2014 run /kk-curate` : `\u{1F4CB} kk queue: ${result.pendingSessions} pending session log(s), ${result.candidateCount} candidate(s)`;
  let content = statusLine + "\n\n" + result.additionalContext;
  if (result.nudged) {
    const box = `\u250C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2510
\u2502 \u{1F6A8} kk curation is overdue            \u2502
...
var AGENTS_HEADER = `<!-- ${PACKAGE_TAG} auto-generated session-start context. Re-run init to remove. -->
`;
async function main() {
  ...
  if (raw.trim().length > 0) {
    try {
      ...
      appendHookDiagnostic("opencode:kk-session-start", "parse", err, paths2.logsDir);
      input = {};
    }
  }
  ...
  try {
    process.stderr.write("\u{1F4D6} kk Index: Loading knowledge base\u2026\n");
...
`);
    process.stderr.write("\u{1F9E0} kk Index: Knowledge base loaded.\n");
  } catch (err) {
