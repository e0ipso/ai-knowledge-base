...
This annotates what the agent-driven `/kk-bootstrap` and the deterministic `bootstrap-incremental` prompt should produce when run against the `bootstrap-docs/` fixture.
